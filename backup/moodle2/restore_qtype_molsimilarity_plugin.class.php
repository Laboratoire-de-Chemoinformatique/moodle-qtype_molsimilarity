 ...
 * needed to restore one molsimilarity qtype plugin
 *
 * @package qtype
 * @subpackage  molsimilarity
 * @copyright  2021 unistra  {@link http://unistra.fr}
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_molsimilarity_plugin extends restore_qtype_extrafields_plugin {
    /**
     * Process the qtype/molsimilarity element
     */
    public function process_molsimilarity($data) {
